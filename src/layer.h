...
public:
	...
	Layer* initialize(const std::vector<double>& bias, const std::vector<std::vector<double>>& weights);
	...
	std::vector<double> backward(const std::vector<double> &inputs, double learning_rate);
